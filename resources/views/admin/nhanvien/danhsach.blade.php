    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        @foreach ($data as $item)
            <tr class="odd gradeX" align="center">
                ...
                <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="{!! route('admin.nhanvien.getDelete',$item->id) !!}"> Delete</a></td>
                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="{!! route('admin.nhanvien.getEdit',$item->id) !!}">Edit</a></td>
            </tr>
        @endforeach
    </table>
</div>
