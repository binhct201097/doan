...
<h3 class="page-header ">
    Sản phẩm /
    <a href="{!! route('admin.sanpham.getAdd') !!}" style="margin-top:-8px;" class="btn btn-info">Thêm mới</a>
</h3>
@stop
@section('content')
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX" align="left">
                        ...
                        <td>
                            <img src="resources/upload/sanpham/{{$item->sanpham_anh}}"
                        ...
                        <td class="center">
                            <a href="{!! route('admin.sanpham.getDelete',$item->id) !!}"
                                onclick="return confirmDel('Bạn có chắc muốn xóa dữ liệu này?')" type="button"
                                class="btn btn-danger" data-toggle="tooltip" data-placement="left" title="Xóa"><i
                                    class="fa fa-trash-o  fa-fw"></i></a></td>
                        </td>
                        <td class="center"> <a href="{!! route('admin.sanpham.getEdit',$item->id) !!}" type="button"
                                class="btn btn-primary" data-toggle="tooltip" data-placement="left" title="Chỉnh sửa"><i
                                    class="fa fa-pencil fa-fw"></i></a></td>
                        <td class="center">
                            <a href="{!! route('admin.lohang.getNhaphang',$item->id) !!}" type="button"
                                class="btn btn-primary" data-toggle="tooltip" data-placement="left" title="Nhập hàng"><i
