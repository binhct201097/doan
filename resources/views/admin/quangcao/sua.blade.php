    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <label>Ảnh</label>
                <br>
                <img src="{!! asset('resources/upload/quangcao/'.$quangcao->quangcao_anh) !!}" class="img-responsive img-rounded" alt="Image" style="width: 50%; height: 50%;">
                <input type="hidden" name="fImageCurrent" value="{!! $quangcao->quangcao_anh !!}">
                <br>
