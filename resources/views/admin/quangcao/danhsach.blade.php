            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td>{!! $item->id !!}</td>
                        <td>
                            <img src="{!! asset('resources/upload/quangcao/'.$item->quangcao_anh) !!}"
                        ...
                        <td align="center">
                            ...
                            <a href="{!! URL::route('admin.quangcao.getChange', [$item->id,0] ) !!}" type="button"
                                class="btn btn-warning" data-toggle="tooltip" data-placement="left"
                                title="Cập nhật trạng thái"><i class="fa fa-retweet"></i>Ẩn ảnh</a>
                            <!-- <input type="hidden" name="txtChange" value="0" /> -->
                            @else
                            <a href="{!! URL::route('admin.quangcao.getChange', [$item->id,1] ) !!}" type="button"
                                class="btn btn-success" data-toggle="tooltip" data-placement="left"
                                title="Cập nhật trạng thái"><i class="fa fa-retweet"></i>Hiện ảnh</a>
                        ...
                        <td class="center" align="center">
                            <a onclick="return confirmDel('Bạn có chắc muốn xóa dữ liệu này?')"
                                href="{!! URL::route('admin.quangcao.getDelete', $item->id ) !!}" type="button"
                        ...
                        <td class="center" align="center"><a
                                href="{!! URL::route('admin.quangcao.getEdit', $item->id ) !!}" type="button"
