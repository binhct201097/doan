        ...
        <tbody>
            ...
            <tr class="odd gradeX">
                ...
                <td align="center">
                    ...
                    <a href="{!! URL::route('admin.quangcao.getChange', [$item->id,0] ) !!}" type="button" class="btn btn-warning" data-toggle="tooltip" data-placement="left" title="Cập nhật trạng thái"><i class="fa fa-retweet"></i>Ẩn ảnh</a>
                    <!-- <input type="hidden" name="txtChange" value="0" /> -->
                    @else
                    <a href="{!! URL::route('admin.quangcao.getChange', [$item->id,1] ) !!}" type="button" class="btn btn-success" data-toggle="tooltip" data-placement="left" title="Cập nhật trạng thái"><i class="fa fa-retweet"></i>Hiện ảnh</a>
