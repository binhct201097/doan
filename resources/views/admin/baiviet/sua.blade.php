...
<form action="" method="POST"  enctype="multipart/form-data">
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <label>Tiêu đề</label>
                <input class="form-control" name="txtBVTittle" value="{!! $baiviet->baiviet_tieu_de !!}"/>
                <div>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <label>Tóm tắt</label>
                <textarea class="form-control" rows="2" name="txtBVResum" placeholder="Mô tả...">{!! $baiviet->baiviet_tom_tat !!}</textarea>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <textarea class="form-control" rows="3" name="txtBVContent" placeholder="Mô tả...">{!! $baiviet->baiviet_noi_dung !!}</textarea>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <br>
                <img src="{!! asset('resources/upload/baiviet/'.$baiviet->baiviet_anh) !!}" class="img-responsive img-rounded" alt="Image" style="width: 150px; height: 200px;">
