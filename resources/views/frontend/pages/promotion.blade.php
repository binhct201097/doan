...
<section id="aa-catg-head-banner">
    ...
    <img src="{!! asset('resources/upload/1350x300.jpg') !!}" alt="fashion img" style="width: 1920px; height: 300px;">
...
?>
                                    ...
                                    <p>
                                        ...
                                        <button type="button"
                                            class="btn btn-danger">{{date('d-m-Y',strtotime($ngaybd))}}</button>
                                        đến
                                        <button type="button"
                                            class="btn btn-danger">{{date('d-m-Y',strtotime($ngaykt))}}</button>
                                    </p>
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img"
                                                    href="{!! url('san-pham',$sanpham->id,$sanpham->sanpham_url) !!}"><img
                                                        src="{!! asset('resources/upload/sanpham/'.$sanpham->sanpham_anh) !!}"
                                                        style="width: 100%; height: 100%;" alt="polo shirt img"></a>
                                                <a class="aa-add-card-btn"
                                                    href="{!! url('mua-hang',[$sanpham->id,$sanpham->sanpham_url]) !!}"><span
                                                        class="fa fa-shopping-cart"></span>Mua ngay</a>
                                                <figcaption>
                                                    <h4 class="aa-product-title"><a
                                                            href="{!! url('san-pham',$sanpham->id,$sanpham->sanpham_url) !!}">{!!
                                                            $sanpham->sanpham_ten !!}</a></h4>
...
?>
                                                ...
                                                <span class="aa-product-price">
                                                    <del>{!! number_format("$sanpham->lohang_gia_ban_ra",0,",",".") !!}
                                                        vnđ</del>
                                                </span>
                                            </figure>
