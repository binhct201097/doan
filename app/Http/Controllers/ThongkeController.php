...
class ThongkeController extends Controller
{
    public function getList()
    {
	    ...
	    $bannhieu = DB::table('lohang')
	   	...
	   	$conhan = DB::table('lohang')
	   			...
	   			->get();		
	   	// print_r($hethan);
    	return view('admin.thongke.tongquan',compact('sl','tonnhieu','bannhieu','hethan','conhan'));
    }
    ...
    public function getNhapvao()
    {
    	...
    	$data = DB::table('lohang')
	    	...
	    	->get();
	    // print_r($sanpham);
	    return view('admin.thongke.sanpham',compact('data','title'));
    }
    ...
    public function getBanchay()
    {
	    ...
	    $data = DB::table('lohang')
	   			...
	   			->get();
	    // print_r($data);
	    return view('admin.thongke.sanpham1',compact('data','title'));
    }
